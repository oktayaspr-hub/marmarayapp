...
const dataJsPath = 'wp-content/plugins/marmaray-core-v2/assets/js/data.js';
...
// ============================================================
// STATIONS ARRAY (Web App expects 0=Gebze, 42=Halkalı)
// ============================================================
...
// Map APK 1-based IDs (1=Halkalı, 43=Gebze) to Web indices (0=Gebze, 42=Halkalı)
const webIdxToApkId = (idx) => 43 - idx;

// APK STATIONS (for name lookups in calculation)
const apkStations = [
  { id: 1,  name: "Halkalı" },
...
// Maps layout properties to maintain compatibility
...
const getCalendarDayTrainRuns = (day, direction) => {
  ...
  if (direction === 'Gebze') { // Halkalı -> Gebze
...
export const getNextTrains = (stationIdx, direction) => {
  ...
  // web direction 'G2H' means Gebze to Halkalı, so APK direction 'Halkalı'
  // web direction 'H2G' means Halkalı to Gebze, so APK direction 'Gebze'
...
// Dummy arrays for backwards compatibility if app.js references them for other things
