...
<head>
    ...
    <meta name="description" content="G??ncel Marmaray sefer saatleri, duraklar aras?? ??cret hesaplama ve canl?? sefer takibi.">
    <?php wp_head(); ?>
</head>
...
<div class="sticky-wrapper">
    ...
    <div class="app-download-banner">
        <div class="app-banner-content">
            <div class="app-banner-text">
                ...
                <span class="app-banner-desc">T??rkiye'nin ilk ve tek Marmaray canl?? takip uygulamam??z?? ??cretsiz olarak hemen indirin!</span>
            </div>
            <div class="app-banner-buttons">
                <a href="#" class="app-store-btn play-store-btn" title="Google Play'den ??ndirin">
                ...
                <a href="#" class="app-store-btn apple-store-btn" title="App Store'dan ??ndirin">
    ...
    <header class="glass-header" id="main-header">
        ...
        <nav class="main-nav" id="main-nav">
            ...
            <a href="<?php echo esc_url( home_url( '/ucret-hesapla' ) ); ?>">??????cret Hesapla</a>
            <a href="<?php echo esc_url( home_url( '/blog' ) ); ?>">Blog</a>
            <a href="<?php echo esc_url( home_url( '/iletisim' ) ); ?>">??leti??im</a>
        </nav>
        ...
        <div class="nav-actions">
            ...
            <button class="action-btn" id="theme-toggle" title="Tema De??i??tir">
            ...
            <button class="action-btn hamburger" id="mobile-toggle" title="Men??">
    ...
    <div class="announcement-banner">
        ...
        <marquee scrollamount="4" style="max-width:800px;">
            <strong style="font-weight:900;">Duyuru:</strong> Tren h??z??, istasyon trafi??i ve yolcu yo??unlu??una ba??l?? olarak sefer saatlerinde mikro farkl??l??klar olabilir. ??yi yolculuklar dileriz.
        </marquee>
    </div>
</div>
